    ...
    <nav className="sticky top-0 z-50 glass" style={{
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex justify-between h-16 items-center">
          ...
          {/* Logo */}
          <Link
            to={role === 'farmer' ? '/farmer/details' : '/home'}
          ...
          <div className="flex items-center gap-2 sm:gap-3">
            ...
            >
              <SettingsIcon
                className={`w-4.5 h-4.5 ${location.pathname === '/settings' ? 'text-green-400' : ''} transition-colors`}
                style={location.pathname === '/settings' ? { animation: 'border-spin 3s linear infinite' } : {}}
                size={18}
              />
              ...
              <div className="flex items-center gap-2">
                ...
                <div className="hidden sm:flex items-center gap-2 px-3 py-1.5 rounded-xl badge-animated" style={{
                  ...
                  <div>
                    ...
                    <p className="text-[10px] font-medium capitalize mt-0.5" style={{ color: role === 'farmer' ? '#86efac' : '#93c5fd' }}>{role}</p>
                  </div>
                </div>
